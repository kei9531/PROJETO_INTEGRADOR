...
botao_atualizar = Button(frameMeio,image=img_add,compound=LEFT,anchor=NW,text = "Atualizar".upper(), width=95,overrelief=RIDGE,font=('ivy 8'),bg=co1,fg=co0)
botao_inserir.place(x=330,y=50)

#botao_deletar
img_delete = Image.open('delete.png')
img_delete= img_delete.resize((20,20))
img_item = ImageTk.PhotoImage(img_delete)
botao_atualizar = Button(frameMeio,image=img_delete,compound=LEFT,anchor=NW,text = "Deletar".upper(), width=95,overrelief=RIDGE,font=('ivy 8'),bg=co1,fg=co0)
...
botao_atualizar = Button(frameMeio,image=img_item,compound=LEFT,anchor=NW,text = "Ver Item".upper(), width=95,overrelief=RIDGE,font=('ivy 8'),bg=co1,fg=co0)
